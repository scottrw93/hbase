...
public class BloomFilterMetrics {
  ...
  /**
   * @return Current value for bloom requests count
   */
  ...
  /**
   * @return Current value for bloom negative results count
   */
  ...
  /**
   * @return Current value for requests which could have used bloom filters but wasn't defined
   * or loaded.
   */
