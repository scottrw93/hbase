 ...
 */
public class ReflectedFunctionCache<I, R> {

  private static final Logger LOG = LoggerFactory.getLogger(ReflectedFunctionCache.class);

  private final Map<String, Function<I, ? extends R>> lambdasByClass = new HashMap<>();
   ...
   * returns a value whose class extends the baseClass. This was primarily designed for use by
   * our Filter and Comparator parseFrom methods.
   */
